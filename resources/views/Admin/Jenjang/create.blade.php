...
<div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-12">
    ...
    <div class="mb-8 border-b border-neutral-800 pb-6">
        <h1 class="text-3xl font-bold">Tambah Jenjang</h1>
        <p class="text-sm text-neutral-500">
            Tambahkan jenjang baru ke dalam sistem
        </p>
    </div>

    <!-- FORM -->
    <div class="glass p-8 w-full max-w-xl">
        <form action="{{ route('jenjangStore') }}" method="POST" class="space-y-6">
            @csrf

            <!-- Nama -->
            <div>
                <label class="block text-xs text-neutral-400 mb-1">Nama Jenjang</label>
